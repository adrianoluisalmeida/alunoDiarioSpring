...
<div class="form-group">
    ...
    <input name="nome" value="${profissional.nome}" type="text" class="form-control" required/>
    <form:errors path="profissional.nome" cssStyle="color:red"/>
</div>

<div class="form-group">
    <label for="email">E-mail: </label>
    <input name="email" value="${profissional.email}" type="text" class="form-control" required/>
    <form:errors path="profissional.email" cssStyle="color:red"/>
</div>

<div class="form-group">
    <label for="funcao">Função: </label>
    <input name="funcao" value="${profissional.funcao}" type="text" class="form-control" required/>
